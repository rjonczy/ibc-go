...
func (suite *MsgTestSuite) TestNewMsgConnectionOpenInit() {
	...
	var testCases = []struct {
		...
		{"invalid counterparty connection ID", &types.MsgConnectionOpenInit{ClientId: connectionID, Counterparty: types.NewCounterparty("clienttotest", "connectiontotest", prefix), Version: version, DelayPeriod: 500, Signer: signer}, false},
...
func (suite *MsgTestSuite) TestNewMsgConnectionOpenTry() {
	...
	var testCases = []struct {
		...
		{"invalid client unpacking", &types.MsgConnectionOpenTry{ClientId: connectionID, PreviousConnectionId: "clienttotesta", ClientState: invalidAny, Counterparty: counterparty, DelayPeriod: 500, CounterpartyVersions: []*types.Version{ibctesting.ConnectionVersion}, ProofHeight: clientHeight, ProofInit: suite.proof, ProofClient: suite.proof, ProofConsensus: suite.proof, ConsensusHeight: clientHeight, Signer: signer}, false},
...
func (suite *MsgTestSuite) TestNewMsgConnectionOpenAck() {
	...
	var testCases = []struct {
		...
		{"invalid unpacking counterparty client", &types.MsgConnectionOpenAck{ConnectionId: connectionID, CounterpartyConnectionId: connectionID, Version: ibctesting.ConnectionVersion, ClientState: invalidAny, ProofHeight: clientHeight, ProofTry: suite.proof, ProofClient: suite.proof, ProofConsensus: suite.proof, ConsensusHeight: clientHeight, Signer: signer}, false},
